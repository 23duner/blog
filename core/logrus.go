...
// Format实现Formatter(entry *logrus.Entry)([]byte,error)接口
...
func InitLogger() *logrus.Logger {
	...
	mLog.SetReportCaller(global.Config.Logger.ShowLine) //开启返回函数名和符号
	mLog.SetFormatter(&LogFormatter{})                  //设置自己定义好的Formatter
